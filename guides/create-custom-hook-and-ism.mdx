...
<Info>
  Hooks currently expect metadata to be formatted with the [`StandardHookMetadata` library](/docs/reference/libraries/hookmetadata).
</Info>
...
The following utility is provided in the [`MailboxClient` library](/docs/reference/libraries/mailboxclient) for convenience.
...
[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/guides/create-custom-hook-and-ism.mdx)
