...
description: "A Hyperlane implementation for a new chain architecture is comprised of the following"
---
...
## 1. Contracts[​](#1-contracts "Direct link to 1. Contracts")
...
### Some things to consider[​](#some-things-to-consider "Direct link to Some things to consider")
...
#### latestDispatchedId[​](#latestdispatchedid "Direct link to latestDispatchedId")
...
### Message Recipient[​](#message-recipient "Direct link to Message Recipient")
...
### Interchain Security Module[​](#interchain-security-module "Direct link to Interchain Security Module")
...
#### moduleType[​](#moduletype "Direct link to moduleType")
...
### Validator Announce[​](#validator-announce "Direct link to Validator Announce")
...
### announce[​](#announce "Direct link to announce")
...
### getAnnouncedStorageLocations[​](#getannouncedstoragelocations "Direct link to getAnnouncedStorageLocations")
...
#### payForGas[​](#payforgas "Direct link to payForGas")
...
#### GasPayment[​](#gaspayment "Direct link to GasPayment")
...
#### DestinationGasConfigSet[​](#destinationgasconfigset "Direct link to DestinationGasConfigSet")
...
## 2. Agents[​](#2-agents "Direct link to 2. Agents")
...
#### Message Indexing[​](#message-indexing "Direct link to Message Indexing")
...
#### Checkpoint with Message ID[​](#checkpoint-with-message-id "Direct link to Checkpoint with Message ID")
...
#### Metadata Builders[​](#metadata-builders "Direct link to Metadata Builders")
...
#### Message Processor[​](#message-processor "Direct link to Message Processor")
...
#### Gas Payment Enforcement[​](#gas-payment-enforcement "Direct link to Gas Payment Enforcement")
...
## 3. Applications[​](#3-applications "Direct link to 3. Applications")

### Warp Routes[​](#warp-routes "Direct link to Warp Routes")
...
#### transferRemote[​](#transferremote "Direct link to transferRemote")
...
#### Transfer Message[​](#transfer-message "Direct link to Transfer Message")
...
[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/guides/implementation-guide.mdx)
