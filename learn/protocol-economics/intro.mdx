---
title: "Overview"
description: "Hyperlane is a permissionless interoperability protocol for cross-chain communication, enabling messages to move across different blockchains."
---
...
## HYPER Token Overview[​](#hyper-token-overview "Direct link to HYPER Token Overview")

### HYPER[​](#hyper "Direct link to HYPER")
...
### stHYPER[​](#sthyper "Direct link to stHYPER")
...
### HYPER vs. stHYPER[​](#hyper-vs-sthyper "Direct link to HYPER vs. stHYPER")
...
### How Staking Works[​](#how-staking-works "Direct link to How Staking Works")
...
### Economic Security Allocation[​](#economic-security-allocation "Direct link to Economic Security Allocation")
...
## Hyperlane Validator Selection and Registration[​](#hyperlane-validator-selection-and-registration "Direct link to Hyperlane Validator Selection and Registration")
...
### Selection process[​](#selection-process "Direct link to Selection process")
...
### Registering as a Symbiotic Operator and Opting In[​](#registering-as-a-symbiotic-operator-and-opting-in "Direct link to Registering as a Symbiotic Operator and Opting In")
...
#### Operator Registration[​](#operator-registration "Direct link to Operator Registration")
...
#### Metadata Submission[​](#metadata-submission "Direct link to Metadata Submission")
...
#### Opting into Hyperlane’s Network and Vault[​](#opting-into-hyperlanes-network-and-vault "Direct link to Opting into Hyperlane’s Network and Vault")
...
### Joining Hyperlane's default ISM[​](#joining-hyperlanes-default-ism "Direct link to Joining Hyperlane's default ISM")
...
### Fraud and Onchain Fraud Attribution[​](#fraud-and-onchain-fraud-attribution "Direct link to Fraud and Onchain Fraud Attribution")
...
### Slashing Penalties and Process[​](#slashing-penalties-and-process "Direct link to Slashing Penalties and Process")
...
### Staker Rewards[​](#staker-rewards "Direct link to Staker Rewards")
...
### Expansion Rewards[​](#expansion-rewards "Direct link to Expansion Rewards")
...
### Streak Multiplier: HyperStreak[​](#streak-multiplier-hyperstreak "Direct link to Streak Multiplier: HyperStreak")
...
#### What is HyperStreak?[​](#what-is-hyperstreak "Direct link to What is HyperStreak?")
...
#### Reward Distribution & Allocation[​](#reward-distribution--allocation "Direct link to Reward Distribution & Allocation")
...
[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/protocol-economics/intro.mdx)
