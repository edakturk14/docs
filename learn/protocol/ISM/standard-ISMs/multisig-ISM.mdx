...
The `MultisigISM` is one of the most commonly used ISM types. These ISMs verify that `m` of `n` [Validators](/learn/protocol/agents/validators) have attested to the validity of a particular interchain message.
