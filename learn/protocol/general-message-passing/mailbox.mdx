---
title: "Mailbox"
description: "The Hyperlane  smart contracts expose an on-chain API for sending and receiving interchain messages. There is a  contract deployed on every chain Hyperlane supports."
---
...
### Message Headers[​](#message-headers "Direct link to Message Headers")
...
See the [`Message` library](/docs/reference/libraries/message) for more information on the message encoding.
...
<Info>
  See
  [`Message.sol`](https://github.com/hyperlane-xyz/hyperlane-monorepo/blob/main/solidity/contracts/libs/Message.sol)for
  more details on Hyperlane message encoding
</Info>

[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/protocol/mailbox.mdx)
