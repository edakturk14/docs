...
2. [**Interchain Fee**](/learn/protocol/core/interchain-gas-payment) – gas to deliver and execute the message on the destination chain, including the relayer fee
...
- [Interchain Gas Payment](/learn/protocol/core/interchain-gas-payment) - Handling gas payments between chains and relayer fees
- [Post Dispatch Hooks](/learn/protocol/core/post-dispatch-hooks-overview) - Framework for executing actions after message dispatch
