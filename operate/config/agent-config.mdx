...
description: "All agents use the same method of configuration which is a multi-layered config approach which allows for easy overriding of default configs. Each layer overrides overlapping values in the previous."
---
...
[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/operate/agent-config.mdx)
