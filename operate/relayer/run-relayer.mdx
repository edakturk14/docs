...
<Check>
  ...
  * We recommend you read through the [**Deploy Hyperlane Local Agents**](/docs/guides/deploy-hyperlane-local-agents) guide to understand how to configure and run the Relayer locally, as well as the [**Run Validators**](/docs/operate/validators/run-validators) documentation before trying to run a production Relayer.
</Check>
...
<Info>
  ...
  * We strongly encourage you to follow the [local agents guide](/docs/guides/deploy-hyperlane-local-agents) to understand how to configure and run the Relayer locally.
</Info>
...
<Check>
  See the [Agent Keys](/docs/operate/set-up-agent-keys) page to set up your Hexadecimal or AWS KMS keys.
</Check>
...
<Info>
  Your Relayer takes both command line arguments and environment variables as configuration. Take a look at the [agent configuration](/docs/operate/agent-config) page and the [configuration reference](/docs/operate/config-reference) for a full list of configuration possibilities.
</Info>
