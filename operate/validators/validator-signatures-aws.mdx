...
If you're only intending to run a Validator for testing or development purposes, consider following the [local setup guide](/guides/chains/deploy-hyperlane-with-local-agents) instead.
...
<Tip>
  ...
  module](/operate/guides/deploy-with-terraform#modules) instead to create the
  S3 bucket with the correct permissions.
</Tip>
