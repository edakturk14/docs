...
description: "For those more familiar with deploying to AWS through infrastructure-as-code tools such as Terraform, we provide an  designed to set up the necessary infrastructure for a Hyperlane Validator on AWS. It automates the creation of resources such as ECS clusters, VPCs, subnets, and security groups required for running a Validator agent."
---
...
### IAM / KMS[​](#iam--kms "Direct link to IAM / KMS")
...
## Main Configuration[​](#main-configuration "Direct link to Main Configuration")
...
### PI configuration[​](#pi-configuration "Direct link to PI configuration")
...
### Individual agent logs[​](#individual-agent-logs "Direct link to Individual agent logs")
...
### Relayer module[​](#relayer-module "Direct link to Relayer module")
...
[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/operate/deploy-with-terraform.mdx)
