---
title: "Hyperlane AVS Operator Guide"
---

## Overview[​](#overview "Direct link to Overview")

Hyperlane validators are light offchain agents responsible for security - they observe messages on an origin chain's [Mailbox](/docs/protocol/mailbox) and if needed sign a merkle root that attests the current state of the mailbox.
...
## 2. Run the validator[​](#2-run-the-validator "Direct link to 2. Run the validator")

Operators that want to quickly deploy a production ready environment using Docker Compose and AWS may wish to use the [Docker Compose quickstart guide](/docs/operate/docker-quickstart).
...
## 3. Set up keys[​](#3-set-up-keys "Direct link to 3. Set up keys")
...
## 4. Register your operator[​](#4-register-your-operator "Direct link to 4. Register your operator")
...
```
 hyperlane avs register --operatorKeyPath <PATH_TO_OPERATOR_KEY> \    --chain <AVS_NETWORK> \    --avsSigningKeyAddress <AVS_SIGNING_ADDRESS>
```
...
### Confirming registration[​](#confirming-registration "Direct link to Confirming registration")
...
You can read more about the AVS protocol design [here](/docs/protocol/economic-security/hyperlane-avs).

[Edit this page](https://github.com/hyperlane-xyz/v3-docs/tree/main/docs/guides/avs-operator-guide.mdx)
